...
def prepare_dataset(config):
    ...
    # selected_columns = ['rally', 'ball_round', 'frame_num', 'roundscore_A', 'roundscore_B', 
    #                     'player', 'type', 'aroundhead', 'backhand', 'landing_height', 'landing_area', 
    #                     'landing_x', 'landing_y', 'lose_reason', 'player_location_area', 
    #                     'player_location_x', 'player_location_y', 'opponent_location_area', 'opponent_location_x', 'opponent_location_y', 
    #                     'set', 'match_id', 'rally_id', 'rally_length']
    train_matches = pd.read_csv(f"{config['data_folder']}train.csv")
    val_matches = pd.read_csv(f"{config['data_folder']}val_given.csv")[selected_columns]
    test_matches = pd.read_csv(f"{config['data_folder']}test_given.csv")[selected_columns]
    # print(train_matches, val_matches, test_matches)
